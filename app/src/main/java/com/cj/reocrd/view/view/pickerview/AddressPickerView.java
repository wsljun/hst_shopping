package com.cj.reocrd.view.view.pickerview;
...
//        }
    ...
    public void selectTab(int type, YwpAddressBean bean){
        switch (type){
            case 1:
                // 跳到下一个选择
                if(null != mYwpAddressBean.getCity()){
                    mTabLayout.getTabAt(1).select(); //设置选择城市
                }else{
                    ToastUtil.showShort("没有相关数据");
                }
                break;
            case 2:
                // 跳到下一个选择
                if(null != mYwpAddressBean.getDistrict()){
                    mTabLayout.getTabAt(2).select(); //设置选择县
                }else{
                    ToastUtil.showShort("没有相关数据");
                }
                break;
...
//                            mTabLayout.getTabAt(1).select();
                            ...
                            mOnAddressPickerSureListener.onItemClick("1",mSelectProvice.getI());
                            break;
                        case 1:
...
//                            mTabLayout.getTabAt(2).select();
                            ...
                            mOnAddressPickerSureListener.onItemClick("2",mSelectCity.getI());
                            break;
                        case 2:
                            ...
                            mOnAddressPickerSureListener.onItemClick("3",mSelectDistrict.getI());
                            break;
                    }
                }
            });
    ...
    public interface OnAddressPickerSureListener {
        ...
        void onItemClick(String layer,String id);
    }
