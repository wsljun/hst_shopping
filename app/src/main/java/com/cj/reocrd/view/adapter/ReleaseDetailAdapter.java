 ...
 * 圈子图片显示
 */
public class ReleaseDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Activity context;
    private final LayoutInflater inflater;
    private List<String> strList = new ArrayList<>();

    public ReleaseDetailAdapter(Activity context, List<Friends.UrlBean> mList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyHolder(inflater.inflate(R.layout.release_pic_item2, parent, false));
    }
