...
public class AllCommentAdapter extends BaseQuickAdapter {
    ...
    protected void convert(BaseViewHolder helper, Object item, int position) {
        ...
        ImageLoaderUtils.displayRound(mContext, helper.getView(R.id.comment_icon), UrlConstants.BASE_URL+goodsCommentBean.getPhoto());
        ImageLoaderUtils.displayRound(mContext, helper.getView(R.id.reply_icon), UrlConstants.BASE_URL+goodsCommentBean.getRphoto());
        ...
        helper.setText(R.id.comment_rtime,goodsCommentBean.getReplytime());
